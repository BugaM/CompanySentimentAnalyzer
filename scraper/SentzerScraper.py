...
parser.add_argument('-ds', type=str, help='Starting date for query search.  Should be in YYYY-DD-MM format.')
parser.add_argument('-de', type=str, help='Ending date for query search.  Should be in YYYY-DD-MM format.')
...
parser.add_argument('-s', action='store_const', const=True, help='Toggle flag for sending data to the database.')
